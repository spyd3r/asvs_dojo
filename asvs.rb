...
issues.each do | issue |
	...
	issue = client.create_issue(repository.full_name, issue_title, description, {:milestone => issue_milestone.to_i <= project_level.to_i ? milestones[issue_milestone] : nil, :labels => "#{issue_section},#{issue_id},Level #{issue_level}, CWE #{issue_cwe.sub('id', '')}"})
